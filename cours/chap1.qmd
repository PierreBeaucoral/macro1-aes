...
#| fig-cap: "Convergence du PIB par habitant, 1990-2025. Chaque point est un pays : abscisse = PIB par habitant en 1990 (PPA, dollars internationaux constants de 2021, échelle logarithmique) ; ordonnée = taux de croissance annuel moyen du PIB par habitant entre 1990 et 2025. Source : Banque mondiale, World Development Indicators, indicateur NY.GDP.PCAP.PP.KD, extraction d'août 2026 ; les valeurs de 2025 sont encore susceptibles d'être révisées."
#| fig-width: 8.4
#| fig-height: 4.7
source(here::here("R/theme_macro.R"))
library(ggplot2)
...
# de croissance annuel moyen 1990-2025 (CAGR), 18 pays. Source unique :
...
# melangerait des bases PPA differentes. Donnees figees dans
# data/convergence_1990_2025.csv : aucun appel reseau au rendu.
df_conv <- read.csv(here::here("data/convergence_1990_2025.csv"))
...
ggplot(df_conv, aes(x = pib_hab_1990, y = croissance_1990_2025, color = groupe)) +
  ...
  labs(
    x = "PIB par habitant en 1990 (PPA, $ int. constants 2021, échelle log)",
    y = "Croissance annuelle moyenne\ndu PIB/hab., 1990-2025 (%)"
  ) +
  theme_macro() +
  theme(
