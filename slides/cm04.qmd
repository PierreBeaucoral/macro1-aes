...
#| fig-cap: "Taux de chômage harmonisé en Europe, 2005. L'Union comptait alors 25 membres : l'UE-15 et les dix entrants de mai 2004. Les pays en gris sont ceux dont la valeur n'est pas renseignée. Source : Eurostat, une_rt_a (définition BIT). Fond de carte : Natural Earth."
#| fig-width: 7
#| fig-height: 4.5
source(here::here("R/theme_macro.R"))
library(ggplot2)
...
# Les valeurs vivent dans data/chomage_europe_2005.csv : une ligne par pays,
# colonne `taux` vide tant que la donnée n'a pas été renseignée. Un pays sans
# valeur reste gris sur la carte, ce que la légende signale.
df_carte <- read.csv(here::here("data/chomage_europe_2005.csv"))
