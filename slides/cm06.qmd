...
p_chomage <- ggplot() +
  ...
  scale_color_manual(values = c("États-Unis" = macro_pal[["bleu2"]], "France" = macro_pal[["rouge"]]), name = NULL) +
  scale_x_continuous(breaks = seq(2000, 2023, 4), limits = c(1999.3, 2023.7)) +
...
p_croissance <- ggplot() +
  ...
  scale_fill_manual(values = c("États-Unis" = macro_pal[["bleu2"]], "France" = macro_pal[["rouge"]]), name = NULL) +
  scale_x_continuous(breaks = seq(2000, 2023, 4), limits = c(1999.3, 2023.7)) +
  labs(x = "Année", y = "Croissance du PIB (%)") +
  theme_macro() +
